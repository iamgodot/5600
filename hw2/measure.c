...
int main() {
    ...
    float io_time = (float) (end.tv_sec * factor + end.tv_usec - start.tv_sec * factor - start.tv_usec) / loops;
    ...
    float context_switch_time = (float) (end.tv_sec * factor + end.tv_usec - start.tv_sec * factor - start.tv_usec - io_time * loops * 2) / loops;
